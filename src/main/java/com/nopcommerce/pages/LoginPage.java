...
public class LoginPage extends BasePage {
   ...
   private ElementUtil elementUtil;
    ...
    // identify elements
    private By loginPageName = By.xpath("//div[@class='page-title']/h1");   //By.xpath("//div[@class='page-title']/h1");
    private By emailField = By.id( "Email");
    private By passwordField = By.id( "Password");
    private By rememberMeCheckbox = By.id( "RememberMe");
    private By loginBtn = By.xpath("//button[text()='Log in']");//a[@class='ico-login']
    ...
    //page chaining - if an action takes you to new a page
